...
async function populate(){
    ...
    let url = "https://giovannisinobolli.github.io/lab3JavaScript-25s/js/i-scream.json";
...
function populateHeader(jsonBody) {
    ...
    paragraph.textContent = `head office: ${jsonBody.headOffice} est. ${jsonBody.estabilished} - Status: ${jsonBody.active ? "yes" : "no"}`;
